...
class CombinedDataWidget:
    ...
    def run(self):
        ...
        widget = self.data_view.run(experiment_widget,file_widget)
        
        self.data_view.tabs.on_trait_change(self.update_filelist,name='selected_index')
        
        return widget
    
class CombinedDataWidget_DataView:
    def run(self,experiment_widget,file_widget):
        self.tabs = ipywidgets.Tab()
        self.tabs.children = [experiment_widget,file_widget]
